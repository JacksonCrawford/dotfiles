...
theme.wallpaper = os.getenv("HOME") .. "/.config/awesome/walls/celestial1.jpg"
...
theme.purple_fg = "#dc9cf6"
theme.white = "#ffffff"

theme.fg_normal = theme.white
theme.fg_focus = theme.blue_fg
theme.fg_urgent = theme.light_bg
theme.bg_normal = "#1C00ff00"
theme.bg_focus = theme.light_bg
theme.bg_urgent = "alpha"
theme.taglist_fg_focus = theme.blue_fg
theme.taglist_default = theme.light_fg
theme.taglist_fg_occupied = theme.purple_fg
theme.taglist_shape = theme.rounded_bar
theme.taglist_bg_empty = theme.light_bg
theme.taglist_bg_occupied = theme.light_bg
...
theme.tasklist_fg_focus = theme.blue_fg
theme.tasklist_shape_border_color_focus = "alpha"
theme.tasklist_shape_border_color_urgent = theme.blue_fg
...
theme.hotkeys_modifiers_fg = theme.blue_fg
theme.hotkeys_font = theme.sysFont
theme.hotkeys_description_font = theme.sysFont
theme.hotkeys_border_color = theme.blue_fg
theme.menu_bg_focus = "alpha"
theme.menu_fg_focus = theme.blue_fg
theme.menu_bg_normal = theme.light_bg
theme.menu_fg_normal = theme.dark_bg
theme.border_width = 2
theme.border_normal = theme.dark_bg
theme.border_focus = theme.blue_fg
...
theme.notification_border_color	= theme.blue_fg
...
local tempr = lain.widget.temp({
    settings = function()
        widget:set_markup(markup.font("hack 20", "    " .. 31.0 .. "°C "))
    end
})
...
--    awful.placement.maximize(dashwibox)
    ...
    local hour = wibox.widget.textclock("<span foreground='" .. theme.blue_fg .."'>%H</span>")
    ...
    local taglist_box = new_widget(taglist, theme.light_bg, theme.light_fg, 100, screen_width / 5)
    local apps_box = new_widget(apps, theme.light_bg, theme.blue_fg, 128, screen_width / 5)
    local tiempo_box = new_widget(time, theme.light_bg, theme.blue_fg, 250, screen_width / 10)
    local date_box = new_widget(date, theme.light_bg, theme.blue_fg, 250, screen_width / 10)
    local ram_box = new_widget(memory, theme.light_bg, theme.purple_fg, 113, screen_width / 10)
    local cpu_box = new_widget(chip, theme.light_bg, theme.blue_fg, 100, screen_width / 10)
    local temp_box = new_widget(temperature, theme.light_bg, theme.blue_fg, 113, screen_width / 10)
    local vol_box = new_widget(volume, theme.light_bg, theme.purple_fg, 128, screen_width / 10)
    local locations_box = new_widget(locations, theme.light_bg, theme.blue_fg, 374, screen_width / 10)
    ...
    local sys_ctrl_box = new_widget(sys_ctrl, theme.light_bg, theme.purple_fg, 128, screen_width / 10)
