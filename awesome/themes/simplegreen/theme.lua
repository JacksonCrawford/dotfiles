...
theme.wallpaper                                 = "~/Pictures/wallpapers/seaFiltered.jpg"
theme.font                                      = "Futura 11"
...
--    return wibox.container.background(wibox.container.margin(widget, 16, 16), bgcolor, theme.powerline_rl)
    return wibox.container.background(wibox.container.margin(widget, 16, 16), bgcolor, gears.shape.rounded_rect(cr, 70, 70, 10))
end
...
--    s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.all, awful.util.taglist_buttons)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 20, bg = theme.color1, fg = theme.fg_normal, shape = gears.shape.rounded_rect })
    ...
    local mediumSpacer = wibox.widget {{
        layout = wibox.layout.align.horizontal,
        expand = "none",
        {
            {
