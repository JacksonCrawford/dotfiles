...
theme.wallpaper                                 = "~/Pictures/wallpapers/train.jpg"
...
--    return wibox.container.background(wibox.container.margin(widget, 16, 16), bgcolor, theme.powerline_rl)
    return wibox.container.background(wibox.container.margin(widget, 16, 16), bgcolor, gears.shape.rounded_bar(cr, 20, 70))
end
...
--    s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.all, awful.util.taglist_buttons)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 20, bg = theme.color1, fg = theme.fg_normal, shape = gears.shape.rounded_bar })
