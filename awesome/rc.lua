...
local tags = {
    ...
    {text = "cmd", type = "dev", defaultApp = terminal},
    {text = "trm", type = "dev", defaultApp = terminal},
    {text = "cam", type = "cam", defaultApp = "zoom.us"},
    {text = "fil", type = "files", defaultApp = filemanager},
    {text = "mkd", type = "write", defaultApp = "apostrophe"},
    {text = "tel", type = "message", defaultApp = "telegram"},
    {text = "git", type = "dev", defaultApp = "xdg-open https://github.com/JacksonCrawford"},
    {text = "evi", type = "read", defaultApp = "evince"},
    {text = "mus", type = "music", defaultApp = "spotify"}
}
...
local tiling_resize_factor = 0.06
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "grave",
    	function()
	    awful.spawn.with_shell("redshift -l 35:-80")
	end,
    ...
    awful.key({ modkey }, "u", function () awful.spawn("firefox https://usfca.instructure.com/") end,
        {description = "open USF canvas", group = hotkeys}),
    awful.key({ modkey, "Shift" }, "u", function () awful.spawn("firefox --new-window https://usfca.instructure.com/") end,
        {description = "open USF canvas (in own window", group = hotkeys}),
    awful.key({ modkey }, "g", function () awful.spawn("firefox https://github.com/") end,
    	{description = "open GitHub", group = hotkeys}),
    awful.key({ modkey, "Shift" }, "g", function () awful.spawn("firefox --new-window https://github.com/") end,
    	{description = "open GitHub", group = hotkeys}),
